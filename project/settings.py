...
RECALBOX_BIOS_PATH = os.path.join('/home', username, 'emulationsystem/BIOS')
# Path to directory that contains system roms directories
RECALBOX_ROMS_PATH = os.path.join('/home', username, 'emulationsystem/roms')
# Path to directory that contains system saves
#RECALBOX_SAVES_PATH = '/home/pi/emulationsystem/roms'
# Path to the Retroarch configuration file
RECALBOX_CONF_PATH = '/opt/emulationsystem/configs/all/retroarch.cfg'
# Path to the Retroarch configuration backup file
RECALBOX_CONF_BACKUP_PATH = '/opt/emulationsystem/configs/all/retroarch.cfg.bak'
...
AS_SCRIPT_PATH = '/opt/emulationsystem/configs/all/autostart.sh'
# Path autostart.sh backup file
AS_SCRIPT_BACKUP_PATH = '/opt/emulationsystem/configs/all/autostart.sh.bak'
